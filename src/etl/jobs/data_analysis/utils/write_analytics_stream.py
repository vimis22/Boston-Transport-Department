...
def write_analytics_stream(
    df: DataFrame, subfolder: str, output_mode: str = "append", query_name: str = None
):
    """
    ...
    logger.info(
        f"Writing analytics to {output_path} (mode: {output_mode}, query: {query_name})"
    )
    return (
